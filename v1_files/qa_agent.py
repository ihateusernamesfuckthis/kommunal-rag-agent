...
from v1_files.embedding import SyvMistralEmbeddingFunction
...
def initialize_db():
    """Initialize database - loads from pre-downloaded ChromaDB"""
    ...
    try:
        ...
        print("⚠️ Make sure ChromaDB was downloaded during startup")
        import traceback
        traceback.print_exc()
